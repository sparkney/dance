 ...
 *
 */
public class BoxFlowLayoutCell{
    ...
    public BoxFlowLayoutCell(ArrayList<Media> parentMediaList,Component component){
        this.parentMediaList = parentMediaList;
        this.component = component;
    }

    public BoxFlowLayoutCell setId(String id){
        this.props.id = id;
        return this;
    }
...
//    }
    ...
    public BoxFlowLayoutCell setDisplay(Media media, boolean display) {
        getProps(media).display = display;
        return this;
    }

    public BoxFlowLayoutCell setHAlign(int hAlign){
        this.props.hAlign = hAlign;
        return this;
    }

    public BoxFlowLayoutCell setRelativeWidth(int relativeWidth){
        this.props.relativeWidth = relativeWidth;
        return this;
    }

    public BoxFlowLayoutCell setRelativeWidth(Media media, float relativeWidth){
        getProps(media).relativeWidth = relativeWidth;
        return this;
    }

    public BoxFlowLayoutCell setSpacing(int spacing){
        this.props.spacing = new Spacing(spacing);
        return this;
    }

    public BoxFlowLayoutCell setSpacing(int top, int right, int bottom, int left){
        this.props.spacing = new Spacing(top,right,bottom,left);
        return this;
    }

    public BoxFlowLayoutCell setSpacing(Spacing spacing){
        this.props.spacing = spacing;
        return this;
    }

    public BoxFlowLayoutCell setBackgroundColor(Color backgroundColor) {
        this.props.backgroundColor = backgroundColor;
        return this;
    }

    public BoxFlowLayoutCell setBackgroundColor(Media media, Color backgroundColor) {
        getProps(media).backgroundColor = backgroundColor;
        return this;
    }

    public BoxFlowLayoutCell setBackgroundImage(BackgroundImage backgroundImage) {
