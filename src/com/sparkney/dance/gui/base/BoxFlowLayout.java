/*
 *
 * Created on den 28 april 2015, 13:45
 *
 * NOTES
 *
 ...
 * TextFlowLayout. (See comment 161201 in Text.) To be able to make boxes float
 * in the text with float:left and float:right, we also need to use display:inline
 ...
 *
 */
public class BoxFlowLayout extends Component{

    protected ArrayList<BoxFlowLayoutCell> cellList = new ArrayList();
    ...
    public BoxFlowLayout setWidth(int width){
        this.defaultContainerProps.width = width;
        return this;
    }
        
    public BoxFlowLayout setRelativeWidth(int relativeWidth){
        this.defaultContainerProps.relativeWidth = relativeWidth;
        return this;
    }
        
    public BoxFlowLayout setNumColumns(int numColumns){
        this.defaultContainerProps.cellRelativeWidth = 100F/numColumns;
        return this;
    }

    public BoxFlowLayout setNumColumns(Media media, int numColumns){
        getProps(media).cellRelativeWidth = 100F/numColumns;
        return this;
    }

    public BoxFlowLayout setRowSpacing(int rowSpacing){
    ...
    public BoxFlowLayout setColSpacing(int colSpacing){
        if(this.defaultContainerProps.cellSpacing==null){
            this.defaultContainerProps.cellSpacing = new Spacing();
        }
    ...
    public BoxFlowLayout setBackgroundColor(Color backgroundColor){
        this.defaultContainerProps.backgroundColor = backgroundColor;
        return this;
    }

    public BoxFlowLayout setBackgroundColor(Media media, Color backgroundColor){
        getProps(media).backgroundColor = backgroundColor;
        return this;
    }

    public BoxFlowLayout setCellBackgroundColor(Color backgroundColor){
        this.defaultContainerProps.cellBackgroundColor = backgroundColor;
        return this;
    }

    public BoxFlowLayout setCellBackgroundColor(Media media, Color backgroundColor){
        getProps(media).cellBackgroundColor = backgroundColor;
        return this;
    }

    public BoxFlowLayoutCell add(Component component){
        BoxFlowLayoutCell cell = new BoxFlowLayoutCell(mediaList,component);
        cellList.add(cell);
        return cell;
    }
    ...
    public void render(Context context) throws Exception{
        ...
        for(int i=0; i<cellList.size(); i++){
            BoxFlowLayoutCell cell = cellList.get(i);
            BoxFlowLayoutCell.Props defaultCellProps = cell.props;
            ...
            defaultCellStyle.append("display:inline-block;");   //Display is always inline-block by default.
            ...
            for(Media media : mediaList){
                ...
                BoxFlowLayoutCell.Props mediaCellProps = cell.mediaMap.get(media);
